...
<template>
    <section id="home" class="relative overflow-hidden min-h-[90vh] flex items-center"
        style="background: linear-gradient(160deg, #3f2615 0%, #57341b 45%, #2a190e 100%);">
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div class="absolute -bottom-40 -left-20 w-[400px] h-[400px] rounded-full bg-bean-rust/20 blur-3xl"></div>
            <!-- Golden crema accent centre -->
        ...
        <div class="absolute inset-0 overflow-hidden pointer-events-none select-none">
            <span class="absolute top-[8%] left-[3%] text-7xl animate-float opacity-20 rotate-12">☕</span>
            <span class="absolute top-[12%] right-[8%] text-6xl animate-float-delayed opacity-20 -rotate-12">🫘</span>
            <span class="absolute bottom-[20%] left-[8%] text-5xl animate-float-slow opacity-15 rotate-6">🌱</span>
            <span class="absolute top-[55%] right-[3%] text-6xl animate-float opacity-15 -rotate-12">📦</span>
            <span class="absolute bottom-[30%] right-[15%] text-5xl animate-float-delayed opacity-20 rotate-12">☕</span>
            <span class="absolute top-[30%] left-[12%] text-4xl animate-wiggle opacity-10">🫘</span>
        </div>
            ...
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
                ...
                <div class="text-white">
                    ...
                    <div class="flex items-center gap-6 mt-12 pt-8 border-t border-white/15">
                        <div>
                            <p class="font-display text-2xl font-extrabold text-accent-300">12+</p>
                            <p class="text-xs text-white/60 font-medium">Single-origin coffees</p>
                        </div>
                        <div class="w-px h-10 bg-white/20"></div>
                        <div>
                            <p class="font-display text-2xl font-extrabold text-accent-300">5 ⭐</p>
                            <p class="text-xs text-white/60 font-medium">Customer rating</p>
                        </div>
                        <div class="w-px h-10 bg-white/20"></div>
                        <div>
                            <p class="font-display text-2xl font-extrabold text-accent-300">48h</p>
                            <p class="text-xs text-white/60 font-medium">Roasted to dispatch</p>
                        </div>
                    </div>
                </div>

                <!-- ── Right: Coffee visual cluster ── -->
                <div class="hidden lg:flex items-center justify-center relative">
                    <!-- Glowing backdrop circle -->
                    <div class="absolute w-[420px] h-[420px] rounded-full bg-white/5 blur-2xl animate-scale-pulse"></div>

                    <!-- Central coffee arrangement -->
                    <div class="relative w-[450px] h-[450px]">
                        ...
                        <div class="absolute bottom-[30%] left-[20%] w-4 h-4 rounded-full bg-bean-caramel animate-float shadow-lg shadow-bean-caramel/50"></div>
                        <div class="absolute top-[60%] right-[5%] w-3 h-3 rounded-full bg-bean-leaf animate-wiggle shadow-lg shadow-bean-leaf/50"></div>
                        <div class="absolute top-[5%] left-[45%] w-4 h-4 rounded-full bg-bean-gold animate-float-delayed shadow-lg shadow-bean-gold/50"></div>
                    </div>
                </div>
            </div>
        </div>
