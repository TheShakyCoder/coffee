        ...
        <div class="hidden lg:flex lg:w-1/2 xl:w-5/12 flex-col bg-gradient-to-br from-brand-600 via-brand-500 to-brand-700 text-white relative overflow-hidden">
            ...
            <div class="relative flex-1 flex flex-col justify-center px-10 xl:px-14">
                <Link href="/" class="flex items-center gap-4 mb-10">
                    <img src="/media/logo.png" alt="Acme Coffee Roasters Logo" class="h-16 w-auto brightness-0 invert opacity-90" />
                    <div>
                        <p class="font-display font-bold text-lg leading-tight">Acme Coffee Roasters</p>
                    </div>
                </Link>
                ...
                <p class="text-white/75 text-base leading-relaxed mb-10 max-w-sm">
                    Manage your coffee, subscriptions, workshops, and more — all in one place.
                </p>

                <!-- Feature bullets -->
                <ul class="space-y-4">
                    <li v-for="item in [
                        { icon: '📅', text: 'Schedule workshops and tastings' },
                        { icon: '📰', text: 'Publish news and announcements' },
                        { icon: '👥', text: 'View and manage subscribers' },
                        { icon: '📊', text: 'Track orders and activity' },
            ...
            <div class="relative px-10 pb-10">
                <p class="text-white/40 text-xs">&copy; {{ new Date().getFullYear() }} Acme Coffee Roasters</p>
            </div>
        </div>
        ...
        <div class="flex-1 flex flex-col bg-gradient-to-br from-warm-50 via-brand-50 to-accent-50">
            ...
            <div class="lg:hidden flex items-center justify-between px-6 pt-6 pb-4">
                <Link href="/" class="flex items-center gap-3">
                    <img src="/media/logo.png" alt="Acme Coffee Roasters Logo" class="h-10 w-auto" />
                    <div>
                        <p class="font-display font-semibold text-brand-600 text-sm leading-tight">Acme Coffee Roasters</p>
                    </div>
                </Link>
