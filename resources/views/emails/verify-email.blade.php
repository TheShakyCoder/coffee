        ...
        <tr>
            <td align="center" style="padding:40px 16px;">
                    ...
                    <tr>
                        <td class="email-body" style="padding:44px 48px 36px;">
                            ...
                            <p style="margin:0 0 28px;font-size:15px;color:#78716c;line-height:1.6;">
                                Thanks for joining Acme Coffee Roasters. Before you get started,
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-bottom:28px;">
                                <tr>
                                    <td style="height:3px;background:linear-gradient(90deg,#b07d4f,#e8d4b8,transparent);border-radius:2px;"></td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="center">
                                        <a href="{{ $verificationUrl }}"
                                           class="btn-primary"
                                           style="display:inline-block;background-color:#6f4422;color:#ffffff;font-size:15px;font-weight:600;text-decoration:none;padding:14px 36px;border-radius:10px;letter-spacing:0.1px;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                   style="background-color:#faf6f2;border:1px solid #e0cab3;border-radius:10px;margin-bottom:28px;">
                                <tr>
                                    <td style="padding:14px 18px;">
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td valign="top" style="padding-right:10px;font-size:18px;line-height:1;">⏱</td>
                                                <td style="font-size:13px;color:#6f4422;line-height:1.5;">
                            ...
                            <p style="margin:0;font-size:13px;color:#a8a29e;line-height:1.6;">
                                If you didn't create an account with Acme Coffee Roasters,
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td style="padding:16px 20px;">
                                        ...
                                        <p style="margin:0;font-size:11px;color:#6f4422;word-break:break-all;line-height:1.5;">
                                            {{ $verificationUrl }}
                                        </p>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <p style="margin:0 0 12px;font-size:12px;color:rgba(255,255,255,0.45);">
                                            Unit 5, The Roastery, Mill Lane, Anytown, AC1 2DE
                                        </p>
                ...
                <p style="margin:20px 0 0;font-size:12px;color:#a8a29e;text-align:center;">
                    ...
                    <a href="{{ config('app.url') }}" style="color:#6f4422;text-decoration:none;">{{ parse_url(config('app.url'), PHP_URL_HOST) }}</a>
                    using this address.
                </p>
