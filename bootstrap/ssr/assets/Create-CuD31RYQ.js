...
var _sfc_main = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<!--[-->`);
			_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(head_default), { title: "Create Role" }, null, _parent));
			_push((0, server_renderer_exports.ssrRenderComponent)(_sfc_main$1, null, {
				header: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_: 1
					}), (0, vue_exports.createVNode)("div", null, [(0, vue_exports.createVNode)("h1", { class: "text-xl font-semibold text-warm-900 font-display" }, "Create Role"), (0, vue_exports.createVNode)("p", { class: "text-sm text-warm-500 mt-0.5" }, "Add a new role to the system")])])];
				}),
				default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<div class="max-w-lg"${_scopeId}><div class="bg-white border border-warm-200 rounded-2xl p-7 shadow-sm"${_scopeId}><form class="space-y-5"${_scopeId}><div${_scopeId}><label for="name" class="block text-xs font-semibold text-warm-700 mb-1.5"${_scopeId}>Role name</label><input${(0, server_renderer_exports.ssrRenderAttr)("value", (0, vue_exports.unref)(form).name)} id="name" type="text" required placeholder="e.g. Editor" class="${(0, server_renderer_exports.ssrRenderClass)([(0, vue_exports.unref)(form).errors.name ? "border-rose-300" : "border-warm-200", "w-full px-4 py-2.5 text-sm border rounded-xl bg-white text-warm-900 focus:outline-none focus:ring-2 focus:ring-brand-400 focus:border-transparent transition placeholder-warm-300"])}"${_scopeId}>`);
						...
						_push(`</div><div${_scopeId}><label for="slug" class="block text-xs font-semibold text-warm-700 mb-1.5"${_scopeId}>Slug</label><input${(0, server_renderer_exports.ssrRenderAttr)("value", (0, vue_exports.unref)(form).slug)} id="slug" type="text" required placeholder="e.g. editor" class="${(0, server_renderer_exports.ssrRenderClass)([(0, vue_exports.unref)(form).errors.slug ? "border-rose-300" : "border-warm-200", "w-full px-4 py-2.5 text-sm border rounded-xl bg-white text-warm-900 focus:outline-none focus:ring-2 focus:ring-brand-400 focus:border-transparent transition placeholder-warm-300 font-mono"])}"${_scopeId}>`);
						...
						(0, vue_exports.createVNode)("div", null, [
							...
							(0, vue_exports.withDirectives)((0, vue_exports.createVNode)("input", {
								...
								class: ["w-full px-4 py-2.5 text-sm border rounded-xl bg-white text-warm-900 focus:outline-none focus:ring-2 focus:ring-brand-400 focus:border-transparent transition placeholder-warm-300", (0, vue_exports.unref)(form).errors.name ? "border-rose-300" : "border-warm-200"]
							}, null, 42, ["onUpdate:modelValue"]), [[vue_exports.vModelText, (0, vue_exports.unref)(form).name]]),
						...
						(0, vue_exports.createVNode)("div", null, [
							...
							(0, vue_exports.withDirectives)((0, vue_exports.createVNode)("input", {
								...
								required: "",
								placeholder: "e.g. editor",
								class: ["w-full px-4 py-2.5 text-sm border rounded-xl bg-white text-warm-900 focus:outline-none focus:ring-2 focus:ring-brand-400 focus:border-transparent transition placeholder-warm-300 font-mono", (0, vue_exports.unref)(form).errors.slug ? "border-rose-300" : "border-warm-200"]
						...
						}, (0, vue_exports.toDisplayString)((0, vue_exports.unref)(form).processing ? "Creating…" : "Create role"), 9, ["disabled"]), (0, vue_exports.createVNode)((0, vue_exports.unref)(link_default), {
							href: "/admin/roles",
							class: "px-6 py-2.5 text-sm font-medium text-warm-600 border border-warm-200 rounded-xl hover:bg-warm-50 transition-colors"
						}, {
