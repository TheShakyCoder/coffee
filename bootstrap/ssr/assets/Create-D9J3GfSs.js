import { i as useForm, o as vue_exports, r as link_default, t as server_renderer_exports } from "../ssr.js";
...
var _sfc_main = {
	...
	setup(__props) {
		const props = __props;
		const itemType = (0, vue_exports.ref)(props.parentId ? "link" : "link");
		const form = useForm({
			label: "",
			href: "",
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push((0, server_renderer_exports.ssrRenderComponent)(_sfc_main$1, (0, vue_exports.mergeProps)({ title: "Menu Builder" }, _attrs), {
				header: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
					...
					else return [(0, vue_exports.createVNode)("h1", { class: "text-3xl font-bold text-warm-900" }, "Create Menu Item")];
				}),
				default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (__props.parentItem) _push(`<div${_scopeId}><label class="block text-sm font-semibold text-warm-900 mb-2"${_scopeId}>Parent Item</label><div class="px-4 py-2.5 bg-brand-50 border border-brand-200 rounded-xl text-sm text-brand-700"${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)(__props.parentItem.label)}</div></div>`);
						else _push(`<!---->`);
						_push(`<div class="flex gap-3 pt-4"${_scopeId}><button type="submit"${(0, server_renderer_exports.ssrIncludeBooleanAttr)((0, vue_exports.unref)(form).processing) ? " disabled" : ""} class="px-6 py-2.5 bg-brand-600 text-white font-semibold rounded-xl hover:bg-brand-700 transition-colors disabled:opacity-50"${_scopeId}> Create Item </button>`);
						...
						__props.parentItem ? ((0, vue_exports.openBlock)(), (0, vue_exports.createBlock)("div", { key: 1 }, [(0, vue_exports.createVNode)("label", { class: "block text-sm font-semibold text-warm-900 mb-2" }, "Parent Item"), (0, vue_exports.createVNode)("div", { class: "px-4 py-2.5 bg-brand-50 border border-brand-200 rounded-xl text-sm text-brand-700" }, (0, vue_exports.toDisplayString)(__props.parentItem.label), 1)])) : (0, vue_exports.createCommentVNode)("", true),
						(0, vue_exports.createVNode)("div", { class: "flex gap-3 pt-4" }, [(0, vue_exports.createVNode)("button", {
							type: "submit",
						...
						}, " Create Item ", 8, ["disabled"]), (0, vue_exports.createVNode)((0, vue_exports.unref)(link_default), {
							href: "/internal/menu-items",
							class: "px-6 py-2.5 border-2 border-warm-200 text-warm-700 font-semibold rounded-xl hover:border-warm-300 transition-colors"
						}, {
