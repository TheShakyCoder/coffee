	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(head_default), {
				title: `${__props.page.title} — Acme Coffee Roasters`,
