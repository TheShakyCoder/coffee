...
var _sfc_main = {
	...
	setup(__props) {
		...
		const thumbnailUrl = (0, vue_exports.ref)(null);
		function autoSlug() {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<!--[-->`);
			_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(head_default), { title: "New Competition" }, null, _parent));
			_push((0, server_renderer_exports.ssrRenderComponent)(_sfc_main$1, null, {
				header: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_: 1
					}), (0, vue_exports.createVNode)("div", null, [(0, vue_exports.createVNode)("h1", { class: "text-xl font-semibold text-warm-900 font-display" }, "New Competition"), (0, vue_exports.createVNode)("p", { class: "text-sm text-warm-500 mt-0.5" }, "Create a competition for members to enter")])])];
				}),
				default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push(`<form class="flex flex-col lg:flex-row gap-6 items-start"${_scopeId}><div class="flex-1 min-w-0 bg-white border border-warm-200 rounded-2xl p-7 shadow-sm space-y-5"${_scopeId}><div${_scopeId}><label class="block text-xs font-semibold text-warm-700 mb-1.5"${_scopeId}>Title</label><input${(0, server_renderer_exports.ssrRenderAttr)("value", (0, vue_exports.unref)(form).title)} type="text" required placeholder="e.g. Summer Photo Competition" class="${(0, server_renderer_exports.ssrRenderClass)([(0, vue_exports.unref)(form).errors.title ? "border-rose-300" : "border-warm-200", "w-full px-4 py-2.5 text-sm border rounded-xl bg-white text-warm-900 focus:outline-none focus:ring-2 focus:ring-brand-400 focus:border-transparent transition placeholder-warm-300"])}"${_scopeId}>`);
						...
						_push(`</div><div${_scopeId}><label class="block text-xs font-semibold text-warm-700 mb-1.5"${_scopeId}>Slug</label><input${(0, server_renderer_exports.ssrRenderAttr)("value", (0, vue_exports.unref)(form).slug)} type="text" required placeholder="summer-photo-competition" class="${(0, server_renderer_exports.ssrRenderClass)([(0, vue_exports.unref)(form).errors.slug ? "border-rose-300" : "border-warm-200", "w-full px-4 py-2.5 text-sm border rounded-xl bg-white text-warm-900 font-mono focus:outline-none focus:ring-2 focus:ring-brand-400 focus:border-transparent transition placeholder-warm-300"])}"${_scopeId}>`);
						...
						_push(`</div><div class="bg-white border border-warm-200 rounded-2xl p-5 shadow-sm space-y-3"${_scopeId}><h3 class="text-xs font-semibold text-warm-700 uppercase tracking-wide"${_scopeId}>Status</h3><select class="${(0, server_renderer_exports.ssrRenderClass)([(0, vue_exports.unref)(form).errors.status ? "border-rose-300" : "border-warm-200", "w-full px-3 py-2.5 text-sm border rounded-xl bg-white text-warm-900 focus:outline-none focus:ring-2 focus:ring-brand-400 focus:border-transparent transition"])}"${_scopeId}><option value="open"${(0, server_renderer_exports.ssrIncludeBooleanAttr)(Array.isArray((0, vue_exports.unref)(form).status) ? (0, server_renderer_exports.ssrLooseContain)((0, vue_exports.unref)(form).status, "open") : (0, server_renderer_exports.ssrLooseEqual)((0, vue_exports.unref)(form).status, "open")) ? " selected" : ""}${_scopeId}>Open — accepting entries</option><option value="closed"${(0, server_renderer_exports.ssrIncludeBooleanAttr)(Array.isArray((0, vue_exports.unref)(form).status) ? (0, server_renderer_exports.ssrLooseContain)((0, vue_exports.unref)(form).status, "closed") : (0, server_renderer_exports.ssrLooseEqual)((0, vue_exports.unref)(form).status, "closed")) ? " selected" : ""}${_scopeId}>Closed — no new entries</option><option value="results"${(0, server_renderer_exports.ssrIncludeBooleanAttr)(Array.isArray((0, vue_exports.unref)(form).status) ? (0, server_renderer_exports.ssrLooseContain)((0, vue_exports.unref)(form).status, "results") : (0, server_renderer_exports.ssrLooseEqual)((0, vue_exports.unref)(form).status, "results")) ? " selected" : ""}${_scopeId}>Results — winner announced</option></select>`);
						if ((0, vue_exports.unref)(form).errors.status) _push(`<p class="text-xs text-rose-600"${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)((0, vue_exports.unref)(form).errors.status)}</p>`);
						else _push(`<!---->`);
						_push(`</div><div class="bg-white border border-warm-200 rounded-2xl p-5 shadow-sm space-y-3"${_scopeId}><h3 class="text-xs font-semibold text-warm-700 uppercase tracking-wide"${_scopeId}>Short description</h3><textarea rows="3" placeholder="Brief summary shown on the competitions list…" class="${(0, server_renderer_exports.ssrRenderClass)([(0, vue_exports.unref)(form).errors.description ? "border-rose-300" : "border-warm-200", "w-full px-3 py-2 text-sm border rounded-xl bg-white text-warm-900 resize-none focus:outline-none focus:ring-2 focus:ring-brand-400 focus:border-transparent transition placeholder-warm-300"])}"${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)((0, vue_exports.unref)(form).description)}</textarea>`);
						if ((0, vue_exports.unref)(form).errors.description) _push(`<p class="text-xs text-rose-600"${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)((0, vue_exports.unref)(form).errors.description)}</p>`);
						else _push(`<!---->`);
						...
						(0, vue_exports.createVNode)("div", null, [
							...
							(0, vue_exports.withDirectives)((0, vue_exports.createVNode)("input", {
								...
								class: ["w-full px-4 py-2.5 text-sm border rounded-xl bg-white text-warm-900 focus:outline-none focus:ring-2 focus:ring-brand-400 focus:border-transparent transition placeholder-warm-300", (0, vue_exports.unref)(form).errors.title ? "border-rose-300" : "border-warm-200"]
							}, null, 42, ["onUpdate:modelValue"]), [[vue_exports.vModelText, (0, vue_exports.unref)(form).title]]),
						...
						(0, vue_exports.createVNode)("div", null, [
							...
							(0, vue_exports.withDirectives)((0, vue_exports.createVNode)("input", {
								...
								class: ["w-full px-4 py-2.5 text-sm border rounded-xl bg-white text-warm-900 font-mono focus:outline-none focus:ring-2 focus:ring-brand-400 focus:border-transparent transition placeholder-warm-300", (0, vue_exports.unref)(form).errors.slug ? "border-rose-300" : "border-warm-200"]
						...
						(0, vue_exports.createVNode)("div", null, [
							(0, vue_exports.createVNode)("label", { class: "block text-xs font-semibold text-warm-700 mb-1.5" }, "Rules & Details"),
						...
						}, (0, vue_exports.toDisplayString)((0, vue_exports.unref)(form).processing ? "Creating…" : "Create competition"), 9, ["disabled"]), (0, vue_exports.createVNode)((0, vue_exports.unref)(link_default), {
							href: "/internal/competitions",
							class: "block w-full px-4 py-2.5 text-center text-sm font-medium text-warm-600 border border-warm-200 rounded-xl hover:bg-warm-50 transition-colors"
						}, {
						...
						(0, vue_exports.createVNode)("div", { class: "bg-white border border-warm-200 rounded-2xl p-5 shadow-sm space-y-3" }, [
							(0, vue_exports.createVNode)("h3", { class: "text-xs font-semibold text-warm-700 uppercase tracking-wide" }, "Status"),
							(0, vue_exports.withDirectives)((0, vue_exports.createVNode)("select", {
								...
								class: ["w-full px-3 py-2.5 text-sm border rounded-xl bg-white text-warm-900 focus:outline-none focus:ring-2 focus:ring-brand-400 focus:border-transparent transition", (0, vue_exports.unref)(form).errors.status ? "border-rose-300" : "border-warm-200"]
							}, [
								(0, vue_exports.createVNode)("option", { value: "open" }, "Open — accepting entries"),
								(0, vue_exports.createVNode)("option", { value: "closed" }, "Closed — no new entries"),
								(0, vue_exports.createVNode)("option", { value: "results" }, "Results — winner announced")
							], 10, ["onUpdate:modelValue"]), [[vue_exports.vModelSelect, (0, vue_exports.unref)(form).status]]),
							(0, vue_exports.unref)(form).errors.status ? ((0, vue_exports.openBlock)(), (0, vue_exports.createBlock)("p", {
								key: 0,
								class: "text-xs text-rose-600"
							}, (0, vue_exports.toDisplayString)((0, vue_exports.unref)(form).errors.status), 1)) : (0, vue_exports.createCommentVNode)("", true)
						]),
						(0, vue_exports.createVNode)("div", { class: "bg-white border border-warm-200 rounded-2xl p-5 shadow-sm space-y-3" }, [
							(0, vue_exports.createVNode)("h3", { class: "text-xs font-semibold text-warm-700 uppercase tracking-wide" }, "Short description"),
