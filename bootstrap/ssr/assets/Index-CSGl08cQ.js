...
var _sfc_main = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<!--[-->`);
			_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(head_default), { title: "Users" }, null, _parent));
			_push((0, server_renderer_exports.ssrRenderComponent)(_sfc_main$1, null, {
				header: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
					...
					else return [(0, vue_exports.createVNode)("h1", { class: "text-xl font-semibold text-warm-900 font-display" }, "Users")];
				}),
				default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						(0, server_renderer_exports.ssrRenderList)(__props.users.data, (user) => {
							_push(`<div class="flex items-center gap-4 px-6 py-3.5"${_scopeId}><div class="w-8 h-8 rounded-full bg-brand-100 flex items-center justify-center text-brand-700 text-xs font-bold shrink-0"${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)(user.name.charAt(0).toUpperCase())}</div><div class="flex-1 min-w-0"${_scopeId}><p class="text-sm font-medium text-warm-900 truncate"${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)(user.name)}</p><p class="text-xs text-warm-400 truncate"${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)(user.email)}</p></div><div class="flex items-center gap-2 shrink-0"${_scopeId}>`);
							_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(link_default), {
								...
								default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
									...
									})])), (0, vue_exports.createTextVNode)(" Roles ")];
								}),
								_: 2
							}, _parent, _scopeId));
							_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(link_default), {
					...
					})])), (0, vue_exports.createTextVNode)(" " + (0, vue_exports.toDisplayString)((0, vue_exports.unref)(page).props.flash.success), 1)])) : (0, vue_exports.createCommentVNode)("", true), (0, vue_exports.createVNode)("div", { class: "bg-white border border-warm-200 rounded-2xl overflow-hidden shadow-sm" }, [(0, vue_exports.createVNode)("div", { class: "px-6 py-4 border-b border-warm-100 bg-warm-50" }, [(0, vue_exports.createVNode)("h2", { class: "text-sm font-semibold text-warm-700" }, "All Users")]), (0, vue_exports.createVNode)("div", { class: "divide-y divide-warm-100" }, [((0, vue_exports.openBlock)(true), (0, vue_exports.createBlock)(vue_exports.Fragment, null, (0, vue_exports.renderList)(__props.users.data, (user) => {
						return (0, vue_exports.openBlock)(), (0, vue_exports.createBlock)("div", {
							key: user.id,
							class: "flex items-center gap-4 px-6 py-3.5"
						}, [
							(0, vue_exports.createVNode)("div", { class: "w-8 h-8 rounded-full bg-brand-100 flex items-center justify-center text-brand-700 text-xs font-bold shrink-0" }, (0, vue_exports.toDisplayString)(user.name.charAt(0).toUpperCase()), 1),
							(0, vue_exports.createVNode)("div", { class: "flex-1 min-w-0" }, [(0, vue_exports.createVNode)("p", { class: "text-sm font-medium text-warm-900 truncate" }, (0, vue_exports.toDisplayString)(user.name), 1), (0, vue_exports.createVNode)("p", { class: "text-xs text-warm-400 truncate" }, (0, vue_exports.toDisplayString)(user.email), 1)]),
