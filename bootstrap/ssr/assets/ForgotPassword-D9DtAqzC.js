		...
		return (_ctx, _push, _parent, _attrs) => {
			_push((0, server_renderer_exports.ssrRenderComponent)(_sfc_main$1, (0, vue_exports.mergeProps)({
				...
				default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
					if (_push) {
						_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(head_default), { title: "Forgot Password" }, null, _parent, _scopeId));
						...
						_push(` ${(0, server_renderer_exports.ssrInterpolate)((0, vue_exports.unref)(form).processing ? "Sending…" : "Send reset link")}</button></form><p class="mt-6 text-center text-sm text-warm-500"${_scopeId}> Remembered it? `);
						_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(link_default), {
							...
							default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
								...
								else return [(0, vue_exports.createTextVNode)(" Back to sign in ")];
							}),
							_: 1
						}, _parent, _scopeId));
						_push(`</p>`);
					} else return [
						(0, vue_exports.createVNode)((0, vue_exports.unref)(head_default), { title: "Forgot Password" }),
						...
						})])) : (0, vue_exports.createCommentVNode)("", true), (0, vue_exports.createTextVNode)(" " + (0, vue_exports.toDisplayString)((0, vue_exports.unref)(form).processing ? "Sending…" : "Send reset link"), 1)], 8, ["disabled"])], 32),
						(0, vue_exports.createVNode)("p", { class: "mt-6 text-center text-sm text-warm-500" }, [(0, vue_exports.createTextVNode)(" Remembered it? "), (0, vue_exports.createVNode)((0, vue_exports.unref)(link_default), {
							href: _ctx.route("login"),
							class: "text-brand-600 hover:text-brand-800 font-medium transition-colors"
						}, {
							default: (0, vue_exports.withCtx)(() => [(0, vue_exports.createTextVNode)(" Back to sign in ")]),
							_: 1
						}, 8, ["href"])])
					];
				}),
