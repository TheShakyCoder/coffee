...
var _sfc_main = {
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<!--[-->`);
			_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(head_default), { title: `Entries — ${__props.competition.title}` }, null, _parent));
			_push((0, server_renderer_exports.ssrRenderComponent)(_sfc_main$1, null, {
				header: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div class="flex-1 min-w-0"${_scopeId}><div class="flex items-center gap-2"${_scopeId}><h1 class="text-xl font-semibold text-warm-900 font-display truncate"${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)(__props.competition.title)}</h1><span class="${(0, server_renderer_exports.ssrRenderClass)([statusLabel[__props.competition.status].cls, "shrink-0 px-2 py-0.5 rounded-full text-xs font-semibold"])}"${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)(statusLabel[__props.competition.status].text)}</span></div><p class="text-sm text-warm-500 mt-0.5"${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)(__props.competition.submissions_count)} entr${(0, server_renderer_exports.ssrInterpolate)(__props.competition.submissions_count === 1 ? "y" : "ies")}</p></div>`);
						_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(link_default), {
							...
							default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
								...
								})])), (0, vue_exports.createTextVNode)(" Edit competition ")];
							}),
							_: 1
						}, _parent, _scopeId));
						_push(`</div>`);
					} else return [(0, vue_exports.createVNode)("div", { class: "flex items-center gap-3" }, [
						...
						(0, vue_exports.createVNode)("div", { class: "flex-1 min-w-0" }, [(0, vue_exports.createVNode)("div", { class: "flex items-center gap-2" }, [(0, vue_exports.createVNode)("h1", { class: "text-xl font-semibold text-warm-900 font-display truncate" }, (0, vue_exports.toDisplayString)(__props.competition.title), 1), (0, vue_exports.createVNode)("span", { class: ["shrink-0 px-2 py-0.5 rounded-full text-xs font-semibold", statusLabel[__props.competition.status].cls] }, (0, vue_exports.toDisplayString)(statusLabel[__props.competition.status].text), 3)]), (0, vue_exports.createVNode)("p", { class: "text-sm text-warm-500 mt-0.5" }, (0, vue_exports.toDisplayString)(__props.competition.submissions_count) + " entr" + (0, vue_exports.toDisplayString)(__props.competition.submissions_count === 1 ? "y" : "ies"), 1)]),
						(0, vue_exports.createVNode)((0, vue_exports.unref)(link_default), {
							href: `/internal/competitions/${__props.competition.id}/edit`,
							class: "inline-flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-warm-600 border border-warm-200 rounded-xl hover:bg-warm-50 transition-colors"
						}, {
				...
				default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						if (!__props.submissions.length) _push(`<div class="text-center py-20 bg-warm-50 rounded-2xl border border-warm-200"${_scopeId}><span class="text-4xl block mb-3"${_scopeId}>📭</span><p class="font-semibold text-warm-800 mb-1"${_scopeId}>No entries yet</p><p class="text-sm text-warm-500"${_scopeId}>Entries will appear here once members submit.</p></div>`);
							...
							(0, server_renderer_exports.ssrRenderList)(__props.submissions, (submission) => {
								_push(`<div class="${(0, server_renderer_exports.ssrRenderClass)([submission.is_winner ? "border-amber-300 ring-2 ring-amber-200" : "border-warm-200", "bg-white border rounded-2xl overflow-hidden shadow-sm flex flex-col"])}"${_scopeId}>`);
								...
								if (submission.image_url) _push(`<img${(0, server_renderer_exports.ssrRenderAttr)("src", submission.image_url)}${(0, server_renderer_exports.ssrRenderAttr)("alt", submission.name)} class="w-full h-auto block"${_scopeId}>`);
								else _push(`<div class="aspect-video bg-warm-100 flex items-center justify-center text-3xl text-warm-300"${_scopeId}> 🖼 </div>`);
								_push(`<div class="p-4 flex-1 flex flex-col gap-3"${_scopeId}><div${_scopeId}><p class="text-sm font-semibold text-warm-900"${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)(submission.name)}</p>`);
								if (submission.description) _push(`<p class="text-xs text-warm-500 mt-1"${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)(submission.description)}</p>`);
								else _push(`<!---->`);
								_push(`</div><div class="flex items-center justify-between mt-auto pt-2 border-t border-warm-100"${_scopeId}><span class="text-xs text-warm-400"${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)(submission.user.name)} · ${(0, server_renderer_exports.ssrInterpolate)(submission.created_at)}</span></div><div class="flex gap-2"${_scopeId}>`);
					...
					})])), (0, vue_exports.createTextVNode)(" " + (0, vue_exports.toDisplayString)((0, vue_exports.unref)(page).props.flash.success), 1)])) : (0, vue_exports.createCommentVNode)("", true), !__props.submissions.length ? ((0, vue_exports.openBlock)(), (0, vue_exports.createBlock)("div", {
						key: 1,
						...
						(0, vue_exports.createVNode)("p", { class: "font-semibold text-warm-800 mb-1" }, "No entries yet"),
						(0, vue_exports.createVNode)("p", { class: "text-sm text-warm-500" }, "Entries will appear here once members submit.")
					])) : ((0, vue_exports.openBlock)(), (0, vue_exports.createBlock)("div", {
						key: 2,
						class: "grid gap-5 sm:grid-cols-2 lg:grid-cols-3"
					}, [((0, vue_exports.openBlock)(true), (0, vue_exports.createBlock)(vue_exports.Fragment, null, (0, vue_exports.renderList)(__props.submissions, (submission) => {
						return (0, vue_exports.openBlock)(), (0, vue_exports.createBlock)("div", {
							...
							submission.is_winner ? ((0, vue_exports.openBlock)(), (0, vue_exports.createBlock)("div", {
								key: 0,
								...
								fill: "currentColor",
								viewBox: "0 0 24 24"
							}, [(0, vue_exports.createVNode)("path", { d: "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" })])), (0, vue_exports.createTextVNode)(" Winner ")])) : (0, vue_exports.createCommentVNode)("", true),
							submission.image_url ? ((0, vue_exports.openBlock)(), (0, vue_exports.createBlock)("img", {
								key: 1,
							...
							(0, vue_exports.createVNode)("div", { class: "p-4 flex-1 flex flex-col gap-3" }, [
								(0, vue_exports.createVNode)("div", null, [(0, vue_exports.createVNode)("p", { class: "text-sm font-semibold text-warm-900" }, (0, vue_exports.toDisplayString)(submission.name), 1), submission.description ? ((0, vue_exports.openBlock)(), (0, vue_exports.createBlock)("p", {
									key: 0,
									class: "text-xs text-warm-500 mt-1"
								}, (0, vue_exports.toDisplayString)(submission.description), 1)) : (0, vue_exports.createCommentVNode)("", true)]),
								(0, vue_exports.createVNode)("div", { class: "flex items-center justify-between mt-auto pt-2 border-t border-warm-100" }, [(0, vue_exports.createVNode)("span", { class: "text-xs text-warm-400" }, (0, vue_exports.toDisplayString)(submission.user.name) + " · " + (0, vue_exports.toDisplayString)(submission.created_at), 1)]),
								(0, vue_exports.createVNode)("div", { class: "flex gap-2" }, [!submission.is_winner ? ((0, vue_exports.openBlock)(), (0, vue_exports.createBlock)("button", {
									key: 0,
								...
								}, " Declare winner ", 8, ["onClick"])) : (0, vue_exports.createCommentVNode)("", true), (0, vue_exports.createVNode)("button", {
