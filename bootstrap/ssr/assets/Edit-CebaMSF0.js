...
var _sfc_main = {
	...
	setup(__props) {
		...
		const thumbnailUrl = (0, vue_exports.ref)(props.page.thumbnail_url ?? null);
		function submit() {
			form.put(`/internal/pages/${props.page.id}`);
		}
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<!--[-->`);
			_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(head_default), { title: `Edit — ${__props.page.title}` }, null, _parent));
			_push((0, server_renderer_exports.ssrRenderComponent)(_sfc_main$1, null, {
				header: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div${_scopeId}><h1 class="text-xl font-semibold text-warm-900 font-display"${_scopeId}>Edit Page</h1><p class="text-sm text-warm-500 mt-0.5 truncate max-w-xs"${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)(__props.page.title)}</p></div></div>`);
						...
						_: 1
					}), (0, vue_exports.createVNode)("div", null, [(0, vue_exports.createVNode)("h1", { class: "text-xl font-semibold text-warm-900 font-display" }, "Edit Page"), (0, vue_exports.createVNode)("p", { class: "text-sm text-warm-500 mt-0.5 truncate max-w-xs" }, (0, vue_exports.toDisplayString)(__props.page.title), 1)])])];
				}),
				default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
					if (_push) {
