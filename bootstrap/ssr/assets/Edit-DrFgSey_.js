...
var _sfc_main = {
	...
	setup(__props) {
		...
		const thumbnailUrl = (0, vue_exports.ref)(props.competition.thumbnail_url ?? null);
		function submit() {
			form.put(`/internal/competitions/${props.competition.id}`);
		}
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<!--[-->`);
			_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(head_default), { title: `Edit — ${__props.competition.title}` }, null, _parent));
			_push((0, server_renderer_exports.ssrRenderComponent)(_sfc_main$1, null, {
				header: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push(`<div${_scopeId}><h1 class="text-xl font-semibold text-warm-900 font-display"${_scopeId}>Edit Competition</h1><p class="text-sm text-warm-500 mt-0.5 truncate max-w-xs"${_scopeId}>${(0, server_renderer_exports.ssrInterpolate)(__props.competition.title)}</p></div></div>`);
						...
						_: 1
					}), (0, vue_exports.createVNode)("div", null, [(0, vue_exports.createVNode)("h1", { class: "text-xl font-semibold text-warm-900 font-display" }, "Edit Competition"), (0, vue_exports.createVNode)("p", { class: "text-sm text-warm-500 mt-0.5 truncate max-w-xs" }, (0, vue_exports.toDisplayString)(__props.competition.title), 1)])])];
				}),
				default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
					if (_push) {
						...
						_push((0, server_renderer_exports.ssrRenderComponent)((0, vue_exports.unref)(link_default), {
							...
							default: (0, vue_exports.withCtx)((_, _push, _parent, _scopeId) => {
								...
								else return [(0, vue_exports.createTextVNode)(" View entries ")];
							}),
							_: 1
						}, _parent, _scopeId));
						...
						(0, vue_exports.createVNode)("div", { class: "bg-white border border-warm-200 rounded-2xl p-5 shadow-sm space-y-3" }, [(0, vue_exports.createVNode)("button", {
							...
							default: (0, vue_exports.withCtx)(() => [(0, vue_exports.createTextVNode)(" View entries ")]),
							_: 1
						}, 8, ["href"])]),
